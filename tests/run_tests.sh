...
run_sql_test "B+ tree id lookup" "tests/test_cases/player_bptree.sql" "1 row selected."
run_sql_test "B+ tree win_count lookup" "tests/test_cases/player_bptree.sql" "2 rows selected."
